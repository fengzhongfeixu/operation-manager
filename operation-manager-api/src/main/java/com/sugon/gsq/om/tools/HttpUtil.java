...
public class HttpUtil {
    ...
    public static OmOperationLog excommand(String url, String message) {
        try{
    ...
    public static Map<String, String> getMessage(String url) {
        ...
        try{
            ...
            String result = entityToString(response.getEntity());
            message = JSONObject.parseObject(result, Map.class);
